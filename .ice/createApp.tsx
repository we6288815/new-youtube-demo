...
function loadModlues(runtime) {
  runtime.loadModlue(
    require('D:/workspace/IceProjects/new-youtube-demo/node_modules/build-plugin-ice-core/lib/module.js')
  );

  runtime.loadModlue(
    require('D:/workspace/IceProjects/new-youtube-demo/node_modules/build-plugin-ice-router/lib/module.js')
  );

  runtime.loadModlue(
    require('D:/workspace/IceProjects/new-youtube-demo/node_modules/build-plugin-ice-logger/lib/module.js')
  );

  runtime.loadModlue(
    require('D:/workspace/IceProjects/new-youtube-demo/node_modules/build-plugin-ice-store/lib/module.js')
  );

  runtime.loadModlue(
    require('D:/workspace/IceProjects/new-youtube-demo/node_modules/build-plugin-ice-auth/lib/module.js')
  );
}

function loadStaticModules(appConfig: IAppConfig) {
  require('D:/workspace/IceProjects/new-youtube-demo/node_modules/build-plugin-ice-request/lib/module.js').default(
    { appConfig }
  );
}
